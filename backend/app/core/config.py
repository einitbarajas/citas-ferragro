...
class Settings(BaseSettings):
    ...
    # Inbox donde Resend sandbox sí entrega (cuenta Resend / Gmail de prueba).
...
def refresh_smtp_settings(*, force_secret_overlay: bool = False) -> bool:
    """
    ...
    """
    if settings.is_production or force_secret_overlay:
