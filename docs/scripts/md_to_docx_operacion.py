"""Regenera operacion_continuidad.docx desde operacion_continuidad.md."""
...
MD_PATH = ROOT / "operacion_continuidad.md"
DOCX_PATH = ROOT / "operacion_continuidad.docx"
...
def main() -> None:
    ...
    doc = Document()
    doc.add_heading("Operación y continuidad — Ferragro Citas", 0)
